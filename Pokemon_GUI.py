...
class PokedexGUI(tk.Tk):
    ...
    def on_search_select(self, event):
        ...
        if selected_name in self.all_names:
            # Update the current index to the selected Pokémon
            self.current_index = self.all_names.index(selected_name)
    ...
    def on_search_key_release(self, event):
        ...
        self.search_box.selection_clear()
        ...
        # Rebind the Combobox dropdown behavior
        self.search_box.bind("<<ComboboxSelected>>", self.on_search_select)
